...
public class MainActivity extends AppCompatActivity {
    ...
    private List<Contact> getListContacts() {
        ...
        Contact contact1 = new Contact("Lê Hoài Phong", R.drawable.hangouts_icon,
                "0387671963", "0387671963",
                "hoaiphong13.11.2002@gmail.com", "20120545@student.hcmus.edu.vn", true);
        contact1.setType(2);
        list.add(contact1);

        Contact contact2 = new Contact("Contact 2", R.drawable.hangouts_icon,
                "0387671963", "0387671963",
                "hoaiphong13.11.2002@gmail.com", "20120545@student.hcmus.edu.vn", true);
        contact2.setType(1);
        list.add(contact2);

        Contact contact3 = new Contact("Contact 3", R.drawable.hangouts_icon,
                "0387671963", "0387671963",
                "hoaiphong13.11.2002@gmail.com", "20120545@student.hcmus.edu.vn", true);
        contact3.setType(1);
        list.add(contact3);

        Contact contact4 = new Contact("Contact 4", R.drawable.hangouts_icon,
                "0387671963", "0387671963",
                "hoaiphong13.11.2002@gmail.com", "20120545@student.hcmus.edu.vn", true);
        contact4.setType(2);
        list.add(contact4);

        Contact contact5 = new Contact("Contact 5", R.drawable.hangouts_icon,
                "0387671963", "0387671963",
                "hoaiphong13.11.2002@gmail.com", "20120545@student.hcmus.edu.vn", true);
        contact5.setType(1);
        list.add(contact5);
